            ...
            <div class="col-md-9 py-3">
                ...
                if (isset($_SESSION['username'])) {
                    ...
                    if (mysqli_num_rows($q) > 0) {
						...
						if(mysqli_num_rows($q) < 5) {
							echo '<hr class="border-bottom border-gray">';
							echo '<h5 class="text-center green">There\'s nothing else for you to see, check posts from other sub-forums</h5>';

							$offset = mysqli_num_rows($q);
							$query2 = "SELECT * FROM posts WHERE subforumId IN (SELECT subId FROM subscriptions WHERE userId <> '$id') ORDER BY id DESC LIMIT $offset, $total_posts_per_page";
							$qf = mysqli_query($db, $query2);
